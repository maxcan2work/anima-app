...
export function animeRouteFromCatalog(result: CatalogSearchResult) {
...
export function catalogRouteSlug(result: CatalogSearchResult) {
...
export function findCatalogResultByRoute(results: CatalogSearchResult[], routeId: string) {
...
export function navigateToRemembered(
  path: string,
